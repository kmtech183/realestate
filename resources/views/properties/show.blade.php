<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"
        x-data="{
            activeImage: '{{ $property->getFirstMediaUrl('images') ?: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1200&q=80' }}'
        }">
        ...
        <!-- Main Grid: Gallery & Details vs Sticky Contact Form -->
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <!-- Left 2 Columns (Gallery, Specs, Description, Amenities) -->
            <div class="lg:col-span-2 space-y-8">
                        ...
                        <div
                            ...
                            @foreach ($property->getMedia('images') as $media)
                                <button type="button"
                                    ...
                                    class="w-20 h-20 rounded-xl overflow-hidden shrink-0 border-2 transition focus:outline-none"
                ...
                <div
                    ...
                    <div
                        class="p-3 bg-slate-50 rounded-2xl">
                        <span
            ...
            <!-- Right Column (Sticky Inquiry Livewire Form) -->
